...
import '../../modules/orders/logic.dart';
    ...
    return InkWell(
      ...
      child: Container(
        decoration: BoxDecoration(
            color: Colors.grey.shade200, borderRadius: BorderRadius.circular(15.sp)),
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            if (orderModel?.isGiftOrder == true) ...[
                              const Icon(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        const Spacer(),
                        Visibility(
                          visible: (orderModel?.orderStatus?.code == 'preparing' ||
