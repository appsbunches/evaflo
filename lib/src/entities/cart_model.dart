import 'GiftCardDetailsModel.dart';
...
class CartModel {
  ...
  CouponModel? coupon;
  GiftCardDetailsModel? giftCardDetails;
  ...
  CartModel.fromJson(dynamic json) {
    ...
    orderStatus =
        json['order_status'] != null ? OrderStatus.fromJson(json['order_status']) : null;
    coupon = json['coupon'] != null ? CouponModel.fromJson(json['coupon']) : null;
    giftCardDetails = json['gift_card_details'] != null ? GiftCardDetailsModel.fromJson(json['gift_card_details']) : null;
...
class Products {
  ...
  Products.fromJson(dynamic json) {
    ...
    meta = json['meta'] != null
        ? json['meta'] is List
            ? null
            : MetaResponseModel.fromJson(json['meta'])
        : null;
    url = json['url'];
...
class Currency {
  ...
  Currency.fromJson(dynamic json) {
    cartCurrency = json['cart_currency'] != null
        ? CartCurrency.fromJson(json['cart_currency'])
        : null;
    cartStoreCurrency = json['cart_store_currency'] != null
        ? CartStoreCurrency.fromJson(json['cart_store_currency'])
        : null;
  }
}
