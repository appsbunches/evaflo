...
class OrderModel {
  ...
  OrderModel.fromJson(dynamic json) {
    ...
    needTransfer = transferStatus &&
        isOrderStatusNotCancelled &&
        isPaymentMethodZidBank &&
        uploadStatus;

    issueDate = json['issue_date'];
    if (!isArabicLanguage) {
      issueDate =
          json['issue_date'].toString().replaceAll('م', 'PM').replaceAll('ص', 'AM');
    }
    isGiftOrder = json['is_gift_order'] == 1;
    giftCardDetails = json['gift_card_details'] != null
        ? GiftCardDetailsModel.fromJson(json['gift_card_details'])
        : null;
  }
}
