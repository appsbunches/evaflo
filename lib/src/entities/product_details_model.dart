...
class ProductDetailsModel {
  ...
  ProductDetailsModel.fromJson(dynamic json) {
    //meta = json['meta'] == null ? null : MetaResponseModel.fromJson(json['meta']);
    id = json['id'];
    sku = json['sku'];
    parentId = json['parent_id'];
    name = getLabelInString(json['name']);
    shortDescription = getLabelInString(json['short_description']);
    description = getLabelInString(json['description']);
    description = description?.replaceAll('&lt;o:p&gt;&lt;/o:p&gt;', '');
    try {
    ...
    description = description?.replaceAll('src="//www', 'src="https://www');
...
/*    if (json['keywords'] != null) {
    ...
    customFields?.sort((a, b) => (a.displayOrder ?? 0).compareTo(b.displayOrder ?? 0));
...
class Attribute {
  ...
  Attribute.fromJson(dynamic json) {
    ...
    slug = json['slug'];
    name = getLabelInString(json['name']);
    value = getLabelInString(json['value'])?.replaceAll('&amp;', '&');
