                ...
                children: [
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      width: double.infinity,
                      decoration: BoxDecoration(
                          color: isArabicLanguage ? primaryColor : Colors.transparent,
                          borderRadius: BorderRadius.circular(15.sp),
                          border: Border.all(
                      ...
                      child: Center(
                          child: Row(
                            ...
                            children: [
                              Icon(
                                Icons.check_circle,
                                color: isArabicLanguage ? Colors.white : Colors.transparent,
                              ),
                              CustomText(
                                "العربية",
                                fontSize: 14,
                                color: isArabicLanguage ? Colors.white : Colors.black,
                                fontWeight: FontWeight.bold,
                              ),
                              const Icon(
                                Icons.check_circle,
