...
class ProductCustomField extends StatelessWidget {
  ...
  const ProductCustomField({required this.productId, required this.customField, Key? key})
      : super(key: key);
          ...
          switch (customField.type) {
            case 'TEXT':
              ...
              logic.observeTextEdit(
                  logic.mapTextEditController[customField.id!], customField.price ?? 0,
                  key: customField.id);
                  ...
                  TextField(
                    ...
                    onChanged: (val) {
                      logic.mapTextEditController[customField.id!]?.text =
                          replaceArabicNumber(val);
                      logic.mapTextEditController[customField.id!]?.selection =
                          TextSelection.fromPosition(TextPosition(
                              offset: logic.mapTextEditController[customField.id!]?.text
                                      .length ??
                                  0));
                    },
                    decoration: InputDecoration(
                              ...
                              return DropdownButtonHideUnderline(
                                child: DropdownButton2(
                                  ...
                                  menuItemStyleData: MenuItemStyleData(
                                      padding: EdgeInsets.zero, height: 55.h),
                            ...
                            children: [
                              ...
                              Stack(
                                children: [
                                  GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      child: logic
                                          ...
                                          : AppConfig.enableHintInFileCustomField
                                              ? CustomText(
                                                  customField.hint,
                                  ...
                                  if (logic.mapTextEditController['#${customField.id}']
                                          ?.text.isNotEmpty ==
                                      true)
                                    Positioned(
                                      top: 0,
                        ...
                        children: [
                          ...
                          Stack(
                            children: [
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(10),
                                      color: Colors.grey.shade300),
                                  child: logic.mapTextEditController['#${customField.id}']
                                              ?.text.isNotEmpty ==
                                          true
                                      ? CustomImage(
                                          url: logic
                                              .mapTextEditController['#${customField.id}']
                                              ?.text,
                                          width: double.infinity,
                                          height: 70,
                                          size: 20,
                              ...
                              if (logic.mapTextEditController['#${customField.id}']?.text
                                      .isNotEmpty ==
                                  true)
                                Positioned(
                                  top: 0,
