...
class OtpPage extends StatelessWidget {
  ...
  OtpPage({Key? key, required this.isEmail, required this.isForRegistration})
      : super(key: key);
                                      ...
                                      Directionality(
                                        ...
                                        child: CustomText(
                                          (logic.loginLogic.selectedCode ??
                                                  AppConfig
                                                      .countriesCodes.first) +
                                              logic.loginLogic.phoneController
                                                  .text,
                                          textAlign: TextAlign.center,
                                        ),
                                      )
                                  ...
                                  return logic.isResendLoading
                                      ...
                                      : InkWell(
                                          ...
                                          child: Column(
                                            children: [
                                              CustomText(
                                                "لم يصلك الرمز؟ طلب مرة أخرى"
                                                    .tr,
                                                color: logic.counter == 60 ||
                                                        logic.counter == 0
                                                    ? secondaryColor
                                                    : Colors.grey,
                                                fontWeight: FontWeight.bold,
