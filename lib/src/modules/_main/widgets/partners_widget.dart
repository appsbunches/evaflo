...
import 'package:entaj/src/modules/_main/widgets/asayel_partners_widget.dart';
...
/*      pageController.addListener(() {
  ...
  Widget build(BuildContext context) {
    if (AppConfig.currentThemeId == asayelThemeId) {
      return AsayelPartnersWidget(
        title: widget.title,
        desc: widget.desc,
        backgroundColor: widget.backgroundColor,
        mainColorTitle: widget.mainColorTitle,
                ...
                Column(
                  children: [
                    SizedBox(
                        ...
                        height: AppConfig.currentThemeId == duvetThemeId
                            ? 50
